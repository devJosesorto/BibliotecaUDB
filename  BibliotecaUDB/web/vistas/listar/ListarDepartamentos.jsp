                            ...
                            <div class="div-table" style="margin:0 !important;">
                                <div class="div-table-row div-table-row-list">
                                    ...
                                    <div class="div-table-cell" style="width: 8%;">
                                        <a href="ControladorEditorial?accion=eliminar&id=<%=obj.getCodDepartamento()%>" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></a>
                                    </div>
                                    <div class="div-table-cell" style="width: 8%;">
                                        <a href="ControladorEditorial?accion=editar&id=<%=obj.getCodDepartamento()%>" class="btn btn-info"><i class="zmdi zmdi-file-text"></i></a>
                                    </div>
