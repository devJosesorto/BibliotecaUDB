<%-- 
    Document   : ListarEditoriales
    Created on : 06-18-2020, 01:36:14 PM
    Author     : José Sorto
--%>
        ...
        <div class="content-page-container full-reset custom-scroll-containers">
            ...
            <div class="container">
                <div class="page-header">
                    <h1 class="all-tittles">Sistema bibliotecario <small>Listado de editoriales</small></h1>
                </div>
            </div>
            ...
            <form class="form-padding">
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="title-flat-form title-flat-blue">Listado de editoriales</div>
                        ...
                        <div class="table-responsive">
                            <div class="div-table" style="margin:0 !important;">
                                <div class="div-table-row div-table-row-list" style="background-color:#DFF0D8; font-weight:bold;">
                                    ...
                                    <div class="div-table-cell" style="width: 22%;">Nombre de la editorial</div>
