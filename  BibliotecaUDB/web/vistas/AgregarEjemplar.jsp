    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <form class="form-padding">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="title-flat-form title-flat-blue">Nuevo Ejemplar</div>
                    ...
                    <div class="col-xs-12">
                        <p class="text-center">
                            ...
                            <button type="submit" name="accion" value="agregarejemplar" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                        </p> 
                    </div>
