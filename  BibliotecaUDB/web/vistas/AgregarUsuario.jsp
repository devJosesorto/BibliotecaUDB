        ...
        <form class="form-padding">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <div class="group-material">
                            ...
                            <select name="txtGenero" class="tooltips-general material-control" data-toggle="tooltip" data-placement="top" title="Elige el Genero" required>
                                ...
                                <option value="F" campo>Femenino</option> 
                                <option value="M" campo>Masculino</option> 
                            ...
                            <select name="txtRol" class="tooltips-general material-control" data-toggle="tooltip" data-placement="top" title="Elige el Rol del usuario" required>
                                ...
                                <%
                                    ...
                                    while (itercat.hasNext()) {
                                        rol = itercat.next();
                                %>
                                <option value="<%=rol.getCodRol()%>"><%=rol.getNombre()%> cod <%=rol.getCodRol()%></option>                              
                                <%}%>
                            </select>
                        </div>
                        <p class="text-center pull-right">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="group-material">
                            <input type="password" name="txtPass" class="material-control tooltips-general" placeholder="Contraseña" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                    ...
                    <div class="col-xs-12">
                        <p class="text-center">
                            ...
                            <button type="submit" name="accion" value="user" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                        </p> 
                    </div>
