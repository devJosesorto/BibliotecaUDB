        ...
        <form class="form-padding">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    %>
                    <input type="hidden" name="txtID" value="<%=obj.getCodCategoria()%>" >

                    <div class="col-xs-12 col-sm-6">
                        <div class="group-material">
                            <input type="text" name="txtCategoria" value="<%=obj.getNombre()%>" class="material-control tooltips-general" placeholder="Nombre del categoria" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la categoria">
                    ...
                    <div class="col-xs-12">
                        <p class="text-center">
                            ...
                            <button type="submit" name="accion" value="EditarCategoria" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                        </p> 
                    </div>
