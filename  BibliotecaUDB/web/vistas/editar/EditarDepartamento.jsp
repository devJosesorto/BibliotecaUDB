                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <input type="text" name="txtNombre" value="<%=obj.getNombre()%>" class="material-control tooltips-general" placeholder="Nombre del autor" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del Departamento">
