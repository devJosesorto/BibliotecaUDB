            ...
            <!CUERPO DEL DOCUMENTO #######################################################################################>
                   ...
                   <div class="col-xs-12 col-sm-6">
                        <div class="group-material">
                            <input type="text" name="titulo" class="material-control tooltips-general" placeholder="Escribe el titulo a buscar" >
                   ...
                   <div class="col-xs-12">
                        <p class="text-left">
                         <button type="submit" name="Buscar" href="controladorPrestamos?accion=listar2&titulo" value="searchbook.jsp" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Buscar</button>
                        </p> 
                    </div> 
                            ...
                            <div class="div-table" style="margin:0 !important;">
                                <div class="div-table-row div-table-row-list">
                                    ...
                                    <div class="div-table-cell" style="width: 8%;">
                                        <a href="index.jsp" class="btn btn-info"><i class="zmdi zmdi-file-text"></i></a>
