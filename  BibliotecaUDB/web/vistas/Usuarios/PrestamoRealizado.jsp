<%-- 
    Document   : PrestamoRealizado
    Created on : 06-21-2020, 10:57:51 AM
    Author     : José Sorto
--%>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
                ...
                <!CAMBIAR NOMBRE #######################################################################################>
                <h1 class="all-tittles">Sistema bibliotecario |<small><%=user%></small></h1>
            </div>
        </div>
        ...
        <form class="form-padding">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <h2 class="text-center all-tittles">Prestamo realizado</h2>
                    
                    <div class="col-xs-12 col-sm-4 col-md-3">
                        <img src="Bootstrap/assets/img/calendar_book.png" alt="calendar" class="img-responsive center-box" style="max-width: 110px;">
                    </div>

                    <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                        Su prestamo se ha realizado satisfactoriamente
                    </div>
